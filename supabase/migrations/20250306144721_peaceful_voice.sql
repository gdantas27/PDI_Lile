...
BEGIN
  IF NOT EXISTS (
    SELECT FROM auth.users WHERE email = 'guest@example.com'
  ) THEN
    ...
    VALUES (
      ...
      'a96ea053-60dd-4579-8d3a-4f9edc0c4ff1',
      'authenticated',
      'authenticated',
      'guest@example.com',
...
BEGIN
  IF NOT EXISTS (
    SELECT FROM public.pdi_data WHERE id = 'a96ea053-60dd-4579-8d3a-4f9edc0c4ff1'
  ) THEN
